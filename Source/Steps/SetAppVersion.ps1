...
# Example call: SetAppVersion -Value "some_string"
...
param (
    ...
    [string]
    $ConstantVI = "$((Get-Item $PSScriptRoot).Parent.Parent.FullName + '\Source\App\Project\AppVersion--constant.vi')"
    ,
...
Write-Output "Setting AppVersion to $Value"
